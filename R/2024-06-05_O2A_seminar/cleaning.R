...
# Remove all leading and trailing white spaces in columns identified as characters (with str_trim {stringr})
...
# Replace the values in 'Threatened status' column with the named vectors using match
...
# Using package worrms for matching with World Register of Marine Species (WoRMS)
